       ...
       try:
           ...
           with torch.no_grad():
               try:
                   ...
                   threat_types = [
                       {"query": "knife or gun or lethal weapon", "level": "HIGH", "type": "weapon"},
                       {"query": "scissors or sharp tools", "level": "MEDIUM", "type": "suspicious person"},
                       {"query": "pen, pencil, or water bottle", "level": "LOW", "type": "writing implement"}
                   ]
